...
if (isset($_POST["submit"])) {
    ...
    if (!empty($result)) {
        ...
        echo "YOUR WELCOME <span class=\"error\">$_COOKIE[$cookie_name]</span>";
        echo "<br>";
        echo "<img src=\"uploads/$a.jpg\" width=200px>";
        echo "<br>";
        echo "press <a href=\"index44.php\" > HERE</a> to change your Avatar<br>";
        echo " <a href=\"index41.php\" >LOG OUT</a>";
    } else {
        echo "<span class=\"error\">there is not user with this Specifications ,please <a href=\"index41.php\" >REGISTER </span>";
    }
}
?>
</center>
